...
#
# Chad Slaughter
# based on algorightms by Reingold, et all
#
# == Overview
#
...
# provides basic support for time zones. 
#
...
#?> (Date.public_methods - Object.public_methods).sort
#=> [
	def self._httpdate() 
	end
 	def self._iso8601() 
...
# (Date.new.public_methods - Object.new.public_methods).sort
#=> [:+, :-, :<, :<<, :<=, :>, :>=, :>>, 
	def ajd() 
	end
 	def amjd() 
